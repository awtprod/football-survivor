...
const DEFAULT = { picks: {}, subscriptions: [], settings: { reminderDay: 6, reminderHour: 12, reminderTz: 'America/New_York', leadHours: [24, 3, 0], chalkFactor: 1, myEntry: '', behaviour: false, elite: [], entrantChalk: {} }, reminded: {}, sg: {} };
let state = DEFAULT;
