...
const DEFAULT = { entryPicks: {}, subscriptions: [], settings: { reminderDay: 6, reminderHour: 12, reminderTz: 'America/New_York', leadHours: [24, 3, 0], chalkFactor: 1, myEntry: '', myEntries: [], lambda: 1, mustDiffer: false, behaviour: false, elite: [], entrantChalk: {}, sgProvider: 'projected' }, reminded: {}, sg: {} };
let state = DEFAULT;
